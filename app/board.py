...
# prompt = """
# You are a seasoned script editor.
# Please generate the storyboard based on the content I input. The storyboard should include all the content of the novel and strictly follow the format I provide. The "text" represents the storyboard text content, "screenKeywords_cn" is the Chinese description of the storyboard content in terms of shot language, and "screenKeywords_en" is the English description of the shot language. A good shot language may include the following categories: characters, actions, scenes, emotions, style, camera angle, lighting and environment.
# Characters: Young man, elderly woman, hero, villain
# Description of characters' age, appearance or character type.
# Actions: Running, smiling, crying, looking in surprise
# Scenes: Forest, city streets, beach, kitchen
# Atmosphere or emotional tone of the scene.
# Art style: Sketch, watercolor, cartoon, realistic, anime
# Camera angle: Close-up, mid-shot, wide-angle, overhead
# Lighting and environment: Sunlight, rainy day, dusk, night scene, backlight
...
# Correct example:
# Young man, drinking, under the starry sky, loneliness, nostalgia, mid-shot, starlight, night
#
# List a few popular cookie recipes in JSON format.
# Use this JSON schema:
# Recipe =[
